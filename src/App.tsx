...
export default function App() {
  ...
  return (
    <div className="flex h-screen flex-col justify-center p-6">
      ...
      <div className="bg-semiDark my-6 rounded-[1em] p-6 shadow-[0px_.75em_0px_#10212A]">
        <p className="headingXS text-silver text-center">
      ...
      <div className="mt-4 flex flex-col space-y-8 text-center">
        <ButtonCPU />
        <ButtonPlayer />
      </div>
    </div>
